            ...
            <form v-on:submit.prevent="editExam">
                ...
                <div class="flex justify-center px-2 py-2">
                    <div class="w-1/3 px-2 py-2">
                        ...
                        <input v-model="questionary.duration" class="bg-white focus:outline-none focus:shadow-outline border border-gray-300 rounded-lg py-2 px-4 block w-full appearance-none leading-normal"  type="text" placeholder="Duracion del examen">
                        <span class="text-xs text-red-600" v-if="errors">
